<nav x-data="{ open: false }" style="background-color: #044771;" class="border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('icons/Logo.png') }}" alt="App Logo" class="h-16 w-18">
                    </a>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('high-alert')" :active="request()->routeIs('high-alert')">
                {{ __('High Alert') }}
            </x-responsive-nav-link>
        </div>
